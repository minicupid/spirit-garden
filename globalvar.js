...
const notepad_btn = document.getElementById('notepad_btn');
const notepad = document.getElementById('notepad');
const close_notepad_btn = document.getElementById('close_notepad_btn');
...
let player_seeds = [
    ...
    { id: "yellow_rare", amount: 50, is_rare: true },
    { id: "brown_rare", amount: 50, is_rare: true },
...
const hybrid_recipes = [
    ...
    { parents: ["blue_rare", "green_rare"], child: "grey_rare" },
